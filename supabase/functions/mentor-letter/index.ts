...
- חלק את המכתב לפסקאות קצרות וברורות עם שורה ריקה בין פסקה לפסקה
- כל משפט יהיה קצר וממוקד (עד 15 מילים)
- הדגש מילות מפתח וביטויים חשובים עם **כוכביות** לא יותר מ-3 הדגשות בפסקה
- אל תשתמש בסימני * בודדים, רק **הדגשה** כפולה
- אורך כל פסקה: 2-4 משפטים מקסימום

אורך המכתב: 200-300 מילים, מחולק ל-5-6 פסקאות קצרות`;
